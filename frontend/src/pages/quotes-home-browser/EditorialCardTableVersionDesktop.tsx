...
const EditorialCardTableVersionDesktop = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-white flex flex-col justify-start px-6 pt-5 pb-5">
        <p className="text-sm leading-relaxed pr-3" style={{ fontFamily: 'Lora, serif', color: '#2d2a26' }}>
      ...
      <div className="bg-white flex flex-col justify-start pt-5 pb-5">
        <EditorialCardTags quote={quote} onTagClick={onTagClick} stackInOneColumn />
      </div>
      <div className="flex flex-col justify-start pl-0 pr-6 pt-5 relative bg-white">
        {quote.article?.title && (
          <p
      ...
      {isEditing && (
        <div className="col-span-4 bg-white p-3 rounded-md" onClick={(e) => e.stopPropagation()}>
          <SharedEditForm
            editForm={editForm}
...
export default EditorialCardTableVersionDesktop;
